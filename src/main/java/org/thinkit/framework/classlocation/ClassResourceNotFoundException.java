 ...
 * @version 1.0
 */
final class ClassResourceNotFoundException extends RuntimeException {
    ...
    /**
     * Constructs an <code>ClassResourceNotFoundException</code> with no detail
     * message.
     */
    ...
    /**
     * Constructs an <code>ClassResourceNotFoundException</code> with the specified
     * detail message.
     *
     * @param s the detail message.
     */
    public ClassResourceNotFoundException(String s) {
        super(s);
    }
